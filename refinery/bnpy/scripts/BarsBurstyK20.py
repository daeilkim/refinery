...
matfilepath = os.environ['BNPYDATADIR'] + 'bars_bnpy_burstyK20_train.mat'

if not os.path.exists(matfilepath):
    matfilepath = data_dir + 'bars_bnpy_burstyK20_train.mat'
...
def get_data_info(D, V):
    return 'Bars Bursty K20 Data. D=%d. VocabSize=%d' % (D,V)
